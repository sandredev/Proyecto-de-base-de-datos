...
CREATE FUNCTION Cantidad_tours_disponibles_por_guía (@idGuía INT)
RETURNS INT
AS
BEGIN
	DECLARE @total INT;
	...
	WHERE e.nombreEstado = 'Disponible' AND t.idGuíaPrincipalTour = @idGuía;
...
AS 
RETURN 
	SELECT	t.idTour, t.idGuíaPrincipalTour, t.nombreTour as [nombre tour], u.nombreUsuario as [nombre guía]
	FROM Tours as t
	JOIN Guías as g
		ON g.idPerfilGuía = t.idGuíaPrincipalTour
	JOIN Perfiles as p
